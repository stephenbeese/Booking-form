document.addEventListener('DOMContentLoaded', () => {
    const properties = [
      ...
      { id: 4, title: "Apartment", description: "Contemporary apartment in the city center, offering stylish interiors, full kitchen, and balcony views. Perfect for urban explorers and business travelers alike.", image: "images/appartment.jpg", price: 160 },
      { id: 5, title: "Coastal Villa", description: "A luxurious coastal villa with panoramic ocean views, featuring modern amenities, a private infinity pool, and spacious terraces for outdoor dining. Perfect for a serene getaway by the sea.", image: "images/coastal-villa.avif", price: 210 },
      { id: 6, title: "Countryside Retreat", description: "A charming countryside retreat nestled among rolling hills, offering cozy interiors, a wood-burning fireplace, and a private garden with a hammock. Ideal for a peaceful escape to nature.", image: "images/countryside-retreat.jpg", price: 95 },
